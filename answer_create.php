...
$sql = 'SELECT COUNT(*) FROM answer_table WHERE answer_user_id = :answer_user_id AND is_answered_user_id = :is_answered_user_id AND question_id = :question_id AND group_id = :group_id';
